...
public class Admin_Student { //관리자모드 > 3.수강생 관리
	...
	private void read() throws FileNotFoundException, IOException {
		BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\user\\Desktop\\source\\수강생.txt"));
		File file = new File("C:\\Users\\user\\Desktop\\source\\수강생.txt");
		String line = null;
	...
	private void filewrite() { //덮어쓰기
		...
		String path = "C:\\Users\\user\\Desktop\\source\\수강생.txt";
