...
<table>
    ...
    <tr>
       <th>소스(코딩)</th>
        <th>관리자, 수강생, 비회원 1:1문의 기능, 강사모드(전체), 관리자(강사관리), 더미 파일 작성(강사)</th>
        <th>비회원, 관리자 수강추천,기자재관리, 성적(강사모드),첫 메인화면, 회원가입 더미파일 작성</th>
        <th>비회원,관리자,수강생 교육과정 조회, 수강생 관리, 수강생 모드,수강생 더미 파일(전체)</th>
        <th>첫 메인화면, <br>회원 가입, 로그인, 수강생 더미파일 작성</th>
        <th>관리자 수업관리, 코드 종합, 교과과목 더미파일 작성</th>
    </tr>
    <tr>
        <th>의견제안, 화면캡쳐</th>
        <th>의견제안, 화면캡쳐</th>
    ...
    <tr>
        <th>역할</th>
        <th>관리자,수강생, 비회원 부분 개발, 버그수정, 의견제안, 문서작업</th>
        <th>비회원, 관리자 부분 개발, 문서작업, 의견제안, 버그수정</th>
        <th>비회원,관리자,수강생 부분 개발, 문서작업, 의견제안</th>
        <th>회원 가입 부분 개발, 문서작업, 소스취합, 버그수정</th>
        <th>관리자 부분 개발, 의견제안, 버그수정</th>
